...
def main():
    ...
    # set machine number and checkpoints
    machine_num = 
    check0 =
    check1 =
    check2 =
    ...
    # start at checkpoints
    tfirst.append(check0)
    tfirst.append(check1)
    tfirst.append(check2)
    tfirst.append(check3)
    tfirst.append(check4)
